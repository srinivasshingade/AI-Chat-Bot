...
# ERROR THRESHORLD is for removing less probability presections
context = {}
        ...
        while results:
            for i in samples['samples']:
                ...
                if i['tag'] == results[0][0]:
                    ...
                    # check if this sample is contextual and applies to this user's conversation
...
def reply():
	...
	if sentence.lower() == "quit":
		return "Your Chat has been ended !"
	return str(answer(sentence))
